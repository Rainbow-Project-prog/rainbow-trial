  ...
  var HIKARI_MESSAGES = [
    ...
    /* ---- Day 2: 2日目の朝(未インストール向け) ---- */
    {
      ...
      body: [
        ...
        '全部のシグナルに乗らなくて OK なんです。',
        '',
        'ところで、もしまだなら...',
        'スマホのホーム画面にこのアプリを追加すると、',
        'シグナル受信時に通知でお知らせできます🌈'
      ],
      from:             '— ひかり より',
    ...
    /* ---- Day 2: 2日目の朝(インストール済み向け) ---- */
    {
      id:      'day2_morning_installed',
      day:     2,
      trigger: 'day_start_installed',
      badge:   '🌤 DAY 2',
      subject: '昨日のトレード、振り返ってみて',
      body: [
        '{nickname}さん、おかえりなさい！',
